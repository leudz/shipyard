...
impl<'tmp, T: Component<Tracking = track::Insertion>> AbstractMut
    for InsertedOrModified<FullRawWindow<'tmp, T, track::Insertion>>
{
    type Out = &'tmp T;
    type Index = usize;
...
impl<'tmp, T: Component<Tracking = track::Modification>> AbstractMut
    for InsertedOrModified<FullRawWindow<'tmp, T, track::Modification>>
{
    type Out = &'tmp T;
    type Index = usize;
...
impl<'tmp, T: Component<Tracking = track::All>> AbstractMut
    for InsertedOrModified<FullRawWindow<'tmp, T, track::All>>
{
    type Out = &'tmp T;
    type Index = usize;
...
impl<'tmp, T: Component<Tracking = track::Insertion>> AbstractMut
    for InsertedOrModified<FullRawWindowMut<'tmp, T, track::Insertion>>
{
    type Out = &'tmp mut T;
    type Index = usize;
...
impl<'tmp, T: Component<Tracking = track::Modification>> AbstractMut
    for InsertedOrModified<FullRawWindowMut<'tmp, T, track::Modification>>
{
    type Out = Mut<'tmp, T>;
    type Index = usize;
...
impl<'tmp, T: Component<Tracking = track::All>> AbstractMut
    for InsertedOrModified<FullRawWindowMut<'tmp, T, track::All>>
{
    type Out = Mut<'tmp, T>;
    type Index = usize;
