...
impl<'tmp, 'v, T: Component> IntoAbstract for Not<Modified<&'tmp View<'v, T>>> {
    type AbsView = Not<Modified<&'tmp SparseSet<T, T::Tracking>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component> IntoAbstract for Not<Modified<&'b ViewMut<'a, T>>> {
    type AbsView = Not<Modified<&'b SparseSet<T, T::Tracking>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component> IntoAbstract for Not<Modified<&'b mut ViewMut<'a, T>>> {
