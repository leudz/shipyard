...
impl<'tmp, 'v, T: Component<Tracking = track::Modification>> IntoAbstract
    for Not<Modified<&'tmp View<'v, T, track::Modification>>>
{
    type AbsView = Not<Modified<&'tmp SparseSet<T, track::Modification>>>;
    type Pack = T;
...
impl<'tmp, 'v, T: Component<Tracking = track::All>> IntoAbstract
    for Not<Modified<&'tmp View<'v, T, track::All>>>
{
    type AbsView = Not<Modified<&'tmp SparseSet<T, track::All>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component<Tracking = track::Modification>> IntoAbstract
    for Not<Modified<&'b ViewMut<'a, T, track::Modification>>>
{
    type AbsView = Not<Modified<&'b SparseSet<T, track::Modification>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component<Tracking = track::All>> IntoAbstract
    for Not<Modified<&'b ViewMut<'a, T, track::All>>>
{
    type AbsView = Not<Modified<&'b SparseSet<T, track::All>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component<Tracking = track::Modification>> IntoAbstract
    for Not<Modified<&'b mut ViewMut<'a, T, track::Modification>>>
{
    type AbsView = Not<Modified<FullRawWindowMut<'b, T, track::Modification>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component<Tracking = track::All>> IntoAbstract
    for Not<Modified<&'b mut ViewMut<'a, T, track::All>>>
{
    type AbsView = Not<Modified<FullRawWindowMut<'b, T, track::All>>>;
    type Pack = T;
