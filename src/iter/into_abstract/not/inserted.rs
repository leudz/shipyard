...
impl<'tmp, 'v, T: Component> IntoAbstract for Not<Inserted<&'tmp View<'v, T>>> {
    type AbsView = Not<Inserted<&'tmp SparseSet<T, T::Tracking>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component> IntoAbstract for Not<Inserted<&'b ViewMut<'a, T>>> {
    type AbsView = Not<Inserted<&'b SparseSet<T, T::Tracking>>>;
    type Pack = T;
...
impl<'a: 'b, 'b, T: Component> IntoAbstract for Not<Inserted<&'b mut ViewMut<'a, T>>> {
