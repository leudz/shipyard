...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__head8d07f060f3a4b: (a: number, b: number) => void;
  readonly closure226_externref_shim: (a: number, b: number, c: any) => void;
