...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb7fe290f4992ffa7: (a: number, b: number) => void;
  readonly closure144_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure225_externref_shim: (a: number, b: number, c: any) => void;
