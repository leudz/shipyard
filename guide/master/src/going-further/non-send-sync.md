...
These storages are accessed with [`NonSend`](https://docs.rs/shipyard/latest/shipyard/borrow/struct.NonSend.html), [`NonSync`](https://docs.rs/shipyard/latest/shipyard/borrow/struct.NonSync.html) and [`NonSendSync`](https://docs.rs/shipyard/latest/shipyard/borrow/struct.NonSendSync.html), for example:
