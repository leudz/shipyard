...
Remember when we added `Friends` to the [`World`](https://docs.rs/shipyard/0.10/shipyard/struct.World.html), each one was assigned an [`EntityId`](https://docs.rs/shipyard/0.10/shipyard/struct.EntityId.html).\
We can iterate over both components and the [`EntityId`](https://docs.rs/shipyard/0.10/shipyard/struct.EntityId.html) of the entity that owns them by using `with_id`.

Then we can use this [`EntityId`](https://docs.rs/shipyard/0.10/shipyard/struct.EntityId.html) to add another component to the vanquished `Friends`.\
...
[`AllStorages`](https://docs.rs/shipyard/0.10/shipyard/struct.AllStorages.html) is the part of [`World`](https://docs.rs/shipyard/0.10/shipyard/struct.World.html) that stores all components and entities.\
We are using it to [`delete_any`](https://docs.rs/shipyard/0.10/shipyard/struct.AllStorages.html#method.delete_any) entity that has a `ToDelete` component in a [`SparseSet`](https://docs.rs/shipyard/0.10/shipyard/struct.SparseSet.html) storage.\
[`SparseSet`](https://docs.rs/shipyard/0.10/shipyard/struct.SparseSet.html) is the storage for all [`Component`](https://docs.rs/shipyard/0.10/shipyard/trait.Component.html)s. [`Unique`](https://docs.rs/shipyard/0.10/shipyard/trait.Unique.html)s have a different storage and you can add custom storages to the [`World`](https://docs.rs/shipyard/0.10/shipyard/struct.World.html) but that's an advanced feature.
...
But this time we need [`EntitiesViewMut`](https://docs.rs/shipyard/0.10/shipyard/struct.EntitiesViewMut.html).
