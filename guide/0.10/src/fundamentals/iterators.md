...
Iteration on views is achieved using [`IntoIter::iter`](https://docs.rs/shipyard/0.10/shipyard/trait.IntoIter.html#tymethod.iter).
...
You can ask an iterator to tell you which entity owns each component by using [`WithId::with_id`](https://docs.rs/shipyard/0.10/shipyard/trait.IntoWithId.html#method.with_id):
...
It's possible to filter entities that don't have a certain component using [`Not`](https://docs.rs/shipyard/0.10/shipyard/struct.Not.html) by adding `!` in front of the view reference.
