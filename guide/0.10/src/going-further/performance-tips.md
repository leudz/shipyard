...
Prefer moving the loop inside [`run`](https://docs.rs/shipyard/0.10/shipyard/struct.World.html#method.run) and move [`borrow`](https://docs.rs/shipyard/0.10/shipyard/struct.World.html#method.borrow)'s call outside the loop.

### `bulk_add_entity`

When creating many entities at the same time remember to call [`bulk_add_entity`](https://docs.rs/shipyard/0.10/shipyard/struct.World.html#method.bulk_add_entity) if possible.
...
Instead of calling [World::delete_entity](https://docs.rs/shipyard/0.10/shipyard/struct.World.html#method.delete_entity) or [AllStorages::delete_entity](https://docs.rs/shipyard/0.10/shipyard/struct.AllStorages.html#method.delete_entity) you can call `delete` on all potential storages using the [Delete](https://docs.rs/shipyard/0.10/shipyard/trait.Delete.html) trait and [Entities::delete_unchecked](https://docs.rs/shipyard/0.10/shipyard/struct.Entities.html#method.delete_unchecked).
